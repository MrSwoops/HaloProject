...
// {
// 	Super::BeginPlay();
// 	if (!CharacterOwner) CharacterOwner = Cast<APlayerCharacter>(GetOwner());
// }
//
...
// }
//
// void UCharacterInteractionComponent::PerformInteractableCheck()
// {
// 	if (!CharacterOwner) return;
// 	auto* CheckComp = CharacterOwner->GetFirstPersonCameraComponent();
// 	if (!CheckComp) return;
// 	
...
// 	FVector EndLocation = StartLocation + (ForwardVector * (CharacterOwner->FirstPersonCameraComponent->IsActive() ? InteractionCheckFirstPersonDistance : InteractionCheckThirdPersonDistance));
//
...
// }
//
// void UCharacterInteractionComponent::OnNewInteractable(UObject* NewInteractable)
// {
...
// }
//
// void UCharacterInteractionComponent::OnLostInteractable()
// {
...
// 	}
// }
// void UCharacterInteractionComponent::Server_RequestInteraction_Implementation(UObject* InteractionObject)
// {
// 	//OnInteract();
...
// }
//
// void UCharacterInteractionComponent::InitializeUI(APlayerController* InController)
// {
